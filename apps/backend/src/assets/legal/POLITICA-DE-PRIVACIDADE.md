...
Esta Política de Privacidade descreve como o **Sistema Rafa ILPI** trata dados pessoais no contexto da prestação de serviços tecnológicos a **Instituições de Longa Permanência para Idosos (ILPIs)**, em ambiente **B2B (Business to Business)**.
...
Inseridos pela ILPI quando aplicável, para fins administrativos e legais.

### 3.3. **Dados de Profissionais**

Dados funcionais e cadastrais necessários à gestão interna da ILPI.

### 3.4. **Logs e Registros de Auditoria**

Registros técnicos de acesso, alterações e operações no sistema, para fins de segurança e conformidade legal.
...
O Sistema Rafa ILPI **não compartilha dados pessoais para fins comerciais**.
...
Cada ILPI deve indicar seu próprio Encarregado.
