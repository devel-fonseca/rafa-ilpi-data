  ...
  for (let i = 0; i < residentes.length; i++) {
    ...
    const resident = await prisma.resident.create({
      data: {
        ...
        rg: residentData.rg,
        rgIssuer: residentData.rgIssuer,
        birthDate: residentData.birthDate,
        gender: residentData.gender,
        civilStatus: residentData.civilStatus,
        bloodType: residentData.bloodType,
        currentPhone: residentData.currentPhone,
        currentCep: residentData.currentCep,
        currentState: residentData.currentState,
        currentCity: residentData.currentCity,
        currentStreet: residentData.currentStreet,
        currentNumber: residentData.currentNumber,
        currentDistrict: residentData.currentDistrict,
        motherName: residentData.motherName,
        fatherName: residentData.fatherName,
        nationality: residentData.nationality,
        birthCity: residentData.birthCity,
        birthState: residentData.birthState,
        ...
        // Campos de saúde importantes
        healthStatus: residentData.healthStatus,
        dependencyLevel: residentData.dependencyLevel,
        specialNeeds: residentData.specialNeeds,
        functionalAspects: residentData.functionalAspects,
        medicationsOnAdmission: residentData.medicationsOnAdmission,
        allergies: residentData.allergies,
        chronicConditions: residentData.chronicConditions,
        dietaryRestrictions: residentData.dietaryRestrictions,
        // Campos de admissão
        admissionDate: residentData.admissionDate || new Date(),
        admissionType: residentData.admissionType,
        admissionReason: residentData.admissionReason,
        admissionConditions: residentData.admissionConditions,
        // Responsável legal (se houver)
        legalGuardianName: residentData.legalGuardianName,
        legalGuardianPhone: residentData.legalGuardianPhone,
        legalGuardianType: residentData.legalGuardianType,
        legalGuardianCep: residentData.legalGuardianCep,
        legalGuardianState: residentData.legalGuardianState,
        legalGuardianCity: residentData.legalGuardianCity,
        legalGuardianStreet: residentData.legalGuardianStreet,
        legalGuardianNumber: residentData.legalGuardianNumber,
        legalGuardianDistrict: residentData.legalGuardianDistrict,
        // Status e contatos
        status: 'Ativo',
        bedId: bed?.id,
