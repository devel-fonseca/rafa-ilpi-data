...
import { useDeleteMedication } from '@/hooks/useMedicationVersioning'
import type { Medication } from '@/api/prescriptions.api'
...
/**
 * Modal para exclusão de Medication com versionamento
      ...
      <AlertDialogContent className="max-w-2xl">
        ...
        <div className="bg-warning/5 dark:bg-warning/90/20 border border-warning/30 dark:border-warning/80 rounded-lg p-4 space-y-3">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="deleteReason"
              placeholder="Ex: Medicamento descontinuado por orientação médica..."
              value={deleteReason}
              onChange={(e) => {
