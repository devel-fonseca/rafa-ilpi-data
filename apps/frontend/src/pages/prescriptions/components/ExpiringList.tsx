...
import type { ExpiringPrescription } from '@/api/prescriptions.api'

interface ExpiringListProps {
  prescriptions: ExpiringPrescription[]
}
        ...
        <div className="space-y-3">
          {prescriptions.map((prescription, index) => {
            ...
            const validUntil = prescription.validUntil
              ...
              : null
            const daysLeft = prescription.daysUntilExpiry

            const isUrgent = daysLeft <= 2

            return (
              <div
                key={`${prescription.residentName}-${index}`}
