...
export enum PermissionType {
  ...
  VIEW_FINANCIAL_OPERATIONS = 'VIEW_FINANCIAL_OPERATIONS',
  MANAGE_FINANCIAL_CATEGORIES = 'MANAGE_FINANCIAL_CATEGORIES',
  MANAGE_FINANCIAL_TRANSACTIONS = 'MANAGE_FINANCIAL_TRANSACTIONS',
  MANAGE_FINANCIAL_ACCOUNTS = 'MANAGE_FINANCIAL_ACCOUNTS',
  MANAGE_FINANCIAL_RECONCILIATION = 'MANAGE_FINANCIAL_RECONCILIATION',
